...
class AllAction extends CommonAction {
    ...
    public function load(){
		...
		$list_goods=$Goods->Field('"商城" as t_name,"mall/detail" as t_url,"goods_id" as t_param,goods_id as t_id,title as t_title,photo as t_photo,concat("￥",round(mall_price,2)) as t_note')->order($orderby)->where($where_goods)->select();
