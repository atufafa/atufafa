...
class HdmobileAction extends CommonAction
{
    ...
    public function create()
    {
        if ($this->isPost()) {
            ...
            $obj = D('Huodong');
            if ($obj->add($data)) {
                $this->tuSuccess('添加成功', U('hdmobile/index'));
            }
            $this->tuError('操作失败');
        } else {
            $this->display();
    ...
    public function delete($huodong_id = 0)
    {
        if (is_numeric($huodong_id) && ($huodong_id = (int) $huodong_id)) {
            ...
            $this->tuSuccess('删除成功', U('hdmobile/index'));
        } else {
    ...
    public function edit($huodong_id = 0)
    {
        ...
        if ($this->isPost()) {
            ...
            if (false !== $obj->save($data)) {
                $this->tuSuccess('操作成功', U('hdmobile/index'));
            }
            $this->tuError('操作失败');
        } else {
    ...
    public function audit($huodong_id = 0)
    {
        if (is_numeric($huodong_id) && ($huodong_id = (int) $huodong_id)) {
            ...
            $this->tuSuccess('审核成功', U('hdmobile/index'));
        } else {
            $huodong_id = $this->_post('huodong_id', false);
            if (is_array($huodong_id)) {
                $obj = D('Huodong');
