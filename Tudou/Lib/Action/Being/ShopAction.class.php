...
class ShopAction extends CommonAction
{
    ...
    public function guide(){
        ...
        $list = $obj->
            alias('shopg')->
            join('tu_shop AS shop ON shop.shop_id=shopg.shop_id')->
            order(array('guide_id' => 'desc'))->where($map)->limit($Page->firstRow . ',' . $Page->listRows)->select();
