...
class AllAction extends CommonAction {
    public function index(){
		...
		$list_ele=$Ele->Field('"外卖" as t_name,"ele/shop" as t_url,"shop_id" as t_param,shop_id as t_id,product_name as t_title,photo as t_photo,concat("￥",round(settlement_price,2)) as t_note')->order($orderby)->where($where_ele)->select();
