<?php
class MarketnoticeAction extends CommonAction{
    ...
    public function addnotice(){
        if($this->isPost()) {
            ...
            $obj = D('NoticeEleStoreMarket');
            if ($obj->add($data)) {
                $this->tuSuccess('添加成功', U('marketnotice/index'));
            }
            $this->tuError('操作失败');
        }
        $this->display();
        ...
        if($id = (int) $id){
            ...
            if($this->isPost()){
                ...
                if(false !== $obj->save($data)){
                    $this->tuSuccess('操作成功', U('marketnotice/index'));
                }
                $this->tuError('操作失败');
            }else{
    ...
    public function delnotice($id){
        if(is_numeric($id) && ($id = (int) $id)) {
            ...
            $obj->delete($id);
            $this->tuSuccess('删除成功', U('marketnotice/index'));
        }
