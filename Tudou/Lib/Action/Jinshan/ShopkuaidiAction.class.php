...
class ShopkuaidiAction extends CommonAction {
	...
	private $create_fields = array('type','shop_id','name', 'tel','express_code');
	...
	public function create() {
		if ($this -> isPost()) {
			...
			$data['id'] = $id;
			if ($obj -> add($data)) {
                D('Logistics')->add(['shop_id'=>$data['shop_id'],'default'=>1,'express_com'=>'1','express_name'=>$data['name'],'closed'=>0,'create_time'=>NOW_TIME,'express_code'=>$data['express_code']]);
