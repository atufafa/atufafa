...
class UserrankAction extends CommonAction{
    private $create_fields = array('rank_name', 'number', 'discount', 'reward','reward2', 'icon', 'icon1','integral', 'prestige', 'rebate', 'price','photo');
    private $edit_fields = array('rank_name', 'number', 'discount', 'reward','reward2','icon', 'icon1','integral', 'prestige', 'rebate','price', 'photo');
    ...
    private function createCheck(){
        ...
        $data['reward2'] = htmlspecialchars($data['reward2']);
