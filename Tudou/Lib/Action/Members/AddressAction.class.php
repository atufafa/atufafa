...
class AddressAction extends CommonAction {
    ...
    public function addressadd() {
        if ($this->isPost()) {
            ...
            if ($obj->add($data)) {
                ...
                $this->tuSuccess('新增收货地址成功', $backurl);
            }
            $this->tuError('操作失败');
        } else {
        ...
        if ($addr_id = (int) $addr_id) {
            ...
            if ($this->isPost()) {
                ...
                if (false !== $obj->save($data)) {
                    $this->tuSuccess('操作成功', U('address/index'));
                }
                $this->tuError('操作失败');
            } else {
    ...
    public function updatedefault($addr_id = 0) {
        if (is_numeric($addr_id) && ($addr_id = (int) $addr_id)) {
            ...
            $this->tuSuccess('设置成功', U('address/index'));
        } else {
            $this->tuError('请选择要设置的收货地址');
        }
    }
