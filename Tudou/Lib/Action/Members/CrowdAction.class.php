   ...
   //往期众筹
	...
	public function create() {
        if ($this->isPost()) {
            ...
            if ($goods_id = $obj->add($data)) {
                ...
                $this->tuSuccess('恭喜你添加众筹成功', U('crowd/crowd_list'));
            }
            $this->tuError('操作失败');
        } else {
            $this->display();
    ...
    private function createCheck() {
        ...
        if (empty($data['details'])) {
            $this->tuError('众筹详情不能为空');
        }
        if ($words = D('Sensitive')->checkWords($data['details'])) {
            $this->tuError('众筹详情含有敏感词：' . $words);
        ...
        if ($goods_id = (int) $goods_id) {
            ...
            if ($this->isPost()) {
                ...
                if (false !== $obj->save($data)) {
                    ...
                    $this->tuSuccess('恭喜您编辑众筹成功', U('crowd/crowd_list'));
                }
                $this->tuError('操作失败');
            } else {
