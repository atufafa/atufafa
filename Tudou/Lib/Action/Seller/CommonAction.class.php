...
class CommonAction extends Action{
    ...
    protected function _initialize(){
        ...
        if(strtolower(MODULE_NAME) != 'passport'){
            ...
            }else if($this->shop['audit'] == 2){
                $this->error('商家未通过审核', U('passport/apply2'));
            }
            ...
            //$params=http_build_query(['mobile'=>$mobile,'shop_id'=>$this->shop_id,'user_type'=>$user_type]);
            ...
            //$service_url='http://chat.atufafa.com/mobile_shop_chat.php?'.$params;
        ...
        $name = D("ShopgradeAuth")->where(array("grade_id"=>$this->shop['auth_id']))->find();
