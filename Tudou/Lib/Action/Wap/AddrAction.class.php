...
class AddrAction extends CommonAction{
    public function update_addr(){
        ...
        if (!$addr_id) {
            ...
            if ($type == 1) {
                $this->tuMsg('恭喜您，操作成功', U('Wap/ele/pay', array('order_id' => $order_id)));
            } elseif ($type == 2) {
                $this->tuMsg('恭喜您，操作成功', U('Wap/mall/pay', array('order_id' => $order_id)));
            } elseif ($type == 3) {
                $this->tuMsg('恭喜您，操作成功', U('Wap/mart/pay', array('order_id' => $order_id)));
            } else {
                $this->tuMsg('恭喜您，操作成功', U('user/addrs/index'));
            }
        }
    }
